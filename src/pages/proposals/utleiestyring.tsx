...
const features = [
  ...
  },
  {
    ...
    title: 'Årlig kostnad',
    description:
      'Kun 2,500,- eks mva. Reduserer kostnader og øker effektiviteten for din bedrift.',
  },
  {
    icon: 'help_outline',
    title: 'Hva tilbyr vi?',
...
const customerFeedback = [
  {
    name: 'Anders L.',
    feedback:
      'Utleiestyring har revolusjonert måten vi håndterer verktøyutleie på. Systemet er enkelt å bruke og har hjulpet oss å spare både tid og penger.',
  },
  {
    name: 'Kari M.',
    feedback:
      'Enkel å sette opp og utrolig brukervennlig! Nå har vi full oversikt over alle våre eiendeler og slipper dobbeltarbeid. Anbefales!',
  },
  {
    name: 'Jonas P.',
    feedback:
      'Et virkelig innovativt system som gjør hverdagen vår mye mer effektiv. Vi har bedre kontroll på verktøyene våre enn noensinne før.',
  },
];
      ...
      <main className="p-4">
          ...
          {features.map((feature, index) => (
            ...
            >
              <div className="flex items-center mb-2">
                <span className="material-icons text-utleiestyring_primary">
                  {feature.icon}
                </span>
        ...
        >
          <h3 className="text-xl font-bold mb-4">
            Oppdag hva Utleiestyring kan gjøre for deg
          </h3>
